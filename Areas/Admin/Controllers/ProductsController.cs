...
namespace DAX_FastFood.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public ProductsController(AppDbContext_Admin context)
        {
            _context = context;
        }
        ...
        {
            var appDbContext_Admin = _context.Products.Include(p => p.Category).Include(p => p.Employee);
        ...
        public async Task<IActionResult> Create([Bind("ProductId,ProductName,Description,Price,Image,Status,CategoryId,EmployeeId")] Product product)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["EmployeeId"] = new SelectList(_context.Employees, "EmployeeId", "Email", product.EmployeeId);
            return View(product);
        }
